...
- Enter Reflections: Replace the `Relections added` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**Reduce Cyclomatic complexity, write testable code, adapting Dependency-inversion and Single-Responsibility principles**
